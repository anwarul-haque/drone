...
#mapCanvas {
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Dashboard {{Auth::user()->role == 3?' Admin':''}}</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-success">
              <div class="inner">
                <h4>21<sup style="font-size: 20px"></sup></h4>
      ...
      <div class="container-fluid">
        ...
        <!-- Main row -->
           ...
           <div class="row" style="margin-left: 20px">
             <div class="card col-sm-6" style="margin-right: 30px" >
                ...
                <ul class="todo-list" data-widget="todo-list">
                  <li>
                    ...
                    <div  class="icheck-primary d-inline ml-2">
                      <input type="checkbox" value="" name="todo1" id="fr">
                      <label for="todoCheck1"></label>
                    </div>
                    <!-- todo text -->
                    <span class="text">Register a pilot</span>
                    <!-- Emphasis label -->
                  ...
                  <li>
                    ...
                    <span class="text">Read the FAQ's</span>
                  ...
                  <li>
                    ...
                    <span class="text">Urgent Notice</span>
                  ...
                  <li>
                    ...
                    <span class="text">Add Drone Images</span>
                  ...
                  <li>
                    ...
                    <span class="text">Add Identity Verification Proof</span>
            ...
            <div class="card bg-gradient-success col-sm-5">
...
function initMap() {
    ...
    var infoWindowContent = [
        ...
        '<ul><li>Flight Time: 12:00pm</li><li>Flight Height: 20mtrs</li></ul>' + '</div>'],
        ['<div class="info_content">' +
